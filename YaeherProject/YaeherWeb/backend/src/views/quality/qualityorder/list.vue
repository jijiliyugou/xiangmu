<template>
  <section v-loading="loading" class="yh-body">
        <div class="yh-list-header flex-between">
             <div>
                <label class="yh-label">星级查询:</label>
                <el-select placeholder="星级查询" v-model="params.evaluateLevel" @change="query">
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="evaluateContent" label="患者评论" align="center" :show-overflow-tooltip="true">
                </el-table-column>
                ...
                <el-table-column label="操作" align="center">
                  <div slot-scope="scope">
                      <yh-button type="reply" title="查看咨询详情" @click.native="routerLink('/qualityorder/consultdetail','view',scope.row.consultID)"
                      ></yh-button>
...
export default {
  ...
  activated () {
    ...
    this.initTableData(this.$api.chargeorderList,this.params);
  },
