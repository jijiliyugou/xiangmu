  ...
  <section v-loading="loading" class="yh-body">
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="averageAnswer" label="平均回答时长" align="center"> 
                </el-table-column>
                <el-table-column prop="averageEvaluate" label="平均评分" align="center"> 
                </el-table-column>
                <el-table-column prop="evaluateTotal" label="评分总值" align="center"> 
                </el-table-column>
...
export default {
  ...
  created(){
    this.initTableData(this.$api.appraisecountList,this.params);
  }
};
</script>
