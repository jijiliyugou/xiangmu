  ...
  <section v-loading="loading" class="yh-body">
        <div class="yh-list-header flex-between">
            <el-button type="primary" 
             icon="el-icon-plus"
              @click="routerLink('/labelgroup/add','add',0)"
              >添加</el-button>
            <!-- 右操作 -->
             <div>
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="groupName" label="组名称" width="160" align="center"></el-table-column>
                <el-table-column prop="lableID" label="标签ID" align="center"> 
                </el-table-column>
                <el-table-column prop="lableName" label="标签名" align="center"> 
                </el-table-column>
                ...
                <el-table-column label="操作" align="center">
                  <div slot-scope="scope">
                      <yh-button type="edit" @click.native="routerLink('/labelgroup/update','update',scope.row.id)"
                      ></yh-button>
                      <yh-button type="delete" @click.native="deleteBatch($api.labelgroupDelete,scope.row.id)"
                      ></yh-button>
                  </div>
                </el-table-column>
           </el-table>
...
export default {
  ...
  activated () {
    ...
    this.initTableData(this.$api.labelgroupList,this.params);
  },
