  ...
  <section v-loading="loading" class="yh-body">
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="operExplain" label="操作说明" align="center"></el-table-column>
                <el-table-column prop="operContent" label="操作内容" align="center">
                  <!-- <div slot-scope="scope">
                    {{JSON.parse(scope.row.operContent)}} 
                  </div> -->
                </el-table-column>
                <el-table-column prop="operType" label="操作类型" align="center"> 
                </el-table-column>
                <el-table-column prop="createdBy" label="创建者" align="center">
                </el-table-column>
...
export default {
  ...
  created(){
    this.getRangeTime();
    this.initTableData(this.$api.systemlogList,this.params);
  }
};
</script>
