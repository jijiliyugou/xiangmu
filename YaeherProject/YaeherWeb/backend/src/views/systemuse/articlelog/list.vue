  ...
  <section v-loading="loading" class="yh-body">
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="operType" label="类型" width="160" align="center"></el-table-column>
                <el-table-column prop="articleID" label="文章ID" align="center">
                </el-table-column>
                <el-table-column prop="type" label="type" align="center">
                </el-table-column>
                <el-table-column prop="isDelete" label="是否删除" width="120" align="center"> 
                  <div slot-scope="scope">
                    <label v-if="scope.row.isDelete">是</label><label v-else>否</label>
                  </div>
                </el-table-column>
...
export default {
  ...
  created(){
    this.getRangeTime();
    this.initTableData(this.$api.articlelogList,this.params);
  }
};
</script>
