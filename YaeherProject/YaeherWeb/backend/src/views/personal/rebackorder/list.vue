  ...
  <section v-loading="loading" class="yh-body">
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="refundRemarks" label="退单原因描述" align="center" :show-overflow-tooltip="true"> 
                </el-table-column>
                ...
                <el-table-column label="操作" align="center">
                  <div slot-scope="scope">
                      <yh-button type="view" @click.native="routerLink('/rebackorder/view','view',scope.row.id+','+scope.row.consultID)"
                      ></yh-button>
                  </div>
                </el-table-column>
           </el-table>
