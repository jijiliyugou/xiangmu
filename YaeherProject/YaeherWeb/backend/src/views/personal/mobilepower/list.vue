  ...
  <section v-loading="loading" class="yh-body">
        <div class="yh-list-header flex-between">
            ...
            <div>
                ...
                <el-select placeholder="激活状态" v-model="params.enabled">
                     <el-option label="全部" :value="''"></el-option>
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column label="操作" align="center" width="120">
                  <div slot-scope="scope">
                      <yh-button type="power" @click.native="routerLink('/mobilepower/powerset','update',scope.row.id)"
                      ></yh-button>
                  </div>
                 </el-table-column>
           </el-table>
...
export default {
  ...
  activated () {
    ...
    this.initTableData(this.$api.mobileList,this.params);
  },
...
<style scoped>
.userimages{display: block;margin:0 auto;width: 30px;height: 30px;border-radius: 100%;}
</style>
