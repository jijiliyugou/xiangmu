  ...
  <section v-loading="loading" class="yh-body">
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="clinicName" label="申请科室" align="center">
                </el-table-column>
                <el-table-column prop="checkRes" label="审核状态" align="center"> 
                </el-table-column>
                ...
                <el-table-column label="操作" align="center">
                  <div slot-scope="scope">
                      <yh-button v-if="scope.row.checkRes=='审核中'" type="check" @click.native="routerLink('/cliniccheck/view','Check',scope.row.id)"
                      ></yh-button>
                      <yh-button type="view" @click.native="routerLink('/cliniccheck/view','view',scope.row.id)"
                      ></yh-button>
                  </div>
                 </el-table-column>
           </el-table>
...
export default {
  ...
  activated () {
    ...
    this.initTableData(this.$api.cliniccheckList,this.params);
  },
