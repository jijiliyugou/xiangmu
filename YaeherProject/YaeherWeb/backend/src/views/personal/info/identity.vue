  ...
  methods: {
    update() {
      if(this.imageUrla!=''&&this.imageUrlb!=''&&this.imageUrlc!=''&&this.imageUrld!=''){
        let arrObj=[this.identityaObj,this.identitybObj,this.workObj,this.qualityObj];
        this.saveDataInfo(this.$api.identityAdd,{doctorFileApplies:arrObj,authType:this.dataInfo.authType,AuthCheckRes:"upload"},"list");
      }else{
