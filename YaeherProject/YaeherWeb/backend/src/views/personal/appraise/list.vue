  ...
  <section v-loading="loading" class="yh-body">
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="evaluateLevel" label="用户评分" align="center"> 
                </el-table-column>
                <el-table-column prop="evaluateContent" label="用户评论" align="center" width="120" :show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="qualityLevel" label="质控评分" align="center" width="80"> 
                </el-table-column>
                ...
                <el-table-column label="操作" align="center">
                  <div slot-scope="scope">
                      <yh-button type="reply" title="咨询回复" @click.native="routerLink('/refer/reply','update',scope.row.consultID)"
                      ></yh-button>
                      <yh-button type="view" @click.native="routerLink('/appraise/view','view',scope.row.id)"
                      ></yh-button>
                  </div>
                 </el-table-column>
           </el-table>
...
export default {
  ...
  activated () {
    ...
    this.initTableData(this.$api.appraiseList,this.params);
  },
