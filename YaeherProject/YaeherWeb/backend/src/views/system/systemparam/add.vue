  ...
  <section class="yh-body" v-loading="loading">
    ...
    <el-form  ref="form" :model="dataInfo" :rules="rules" 
      ...
      <el-form-item label="systemType" class="flex-100" prop="systemType">
          <el-input v-model="dataInfo.systemType" class="yh-width-fixed"></el-input>
      </el-form-item>
      <el-form-item label="systemCode" class="flex-100" prop="systemCode">
          <el-input v-model="dataInfo.systemCode" class="yh-width-fixed"></el-input>
      </el-form-item>
      ...
      <el-form-item label="code" class="flex-100" prop="code">
          <el-input v-model="dataInfo.code" class="yh-width-fixed"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    update() {
      this.saveDataInfo(this.$api.systemAdd,this.dataInfo,"list");
    }
  },
  created(){
    this.loading=false;
