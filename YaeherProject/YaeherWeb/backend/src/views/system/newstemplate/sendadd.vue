...
export default {
  ...
  methods: {
    savesendDataInfo(url, params, backUrl) {
    ...
    update() {
      this.savesendDataInfo(this.$api.WXModelSendAdd,this.dataInfo,this.type);
    }
  },
  created(){
    this.dataInfo.templateCode=this.id;
    axios
        .all([
