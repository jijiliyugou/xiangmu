  ...
  <section v-loading="loading" class="yh-body">
        <div class="yh-list-header flex-between">
            <el-button type="primary" 
             icon="el-icon-plus"
              @click="routerLink('/port/add','add',0)"
              >添加</el-button>
            <!-- 右操作 -->
             <div>
        ...
        <div class="yh-container">
           <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="interfaceName" label="端口名称" width="160" align="center"></el-table-column>
                <el-table-column prop="interfaceIntro" label="端口说明" align="center"> 
                </el-table-column>
                <el-table-column prop="interfaceAddress" label="端口地址" width="120" align="center">
                </el-table-column>
                ...
                <el-table-column label="操作" align="center">
                  <div slot-scope="scope">
                      <yh-button type="edit" @click.native="routerLink('/port/update','update',scope.row.id)"
                      ></yh-button>
                       <yh-button type="delete" @click.native="deleteBatch($api.portDelete,scope.row.id)"
                       ></yh-button>
                  </div>
                 </el-table-column>
           </el-table>
...
export default {
  ...
  activated () {
    ...
    this.initTableData(this.$api.portList,this.params);
  },
