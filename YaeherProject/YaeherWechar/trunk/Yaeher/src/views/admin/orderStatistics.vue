<template>
    <div class="order-statistics padding-top">
        <mt-header fixed title="订单统计">
        ...
        <div class="content">
            ...
            <div>
                ...
                <ul>
                    <li class="flexList">
                        本{{yearshow1 | sexSelect}}订单总数：{{charkDetail.orderTotal}}
                    </li>
                    <li class="flexList">
                        订单总价：{{charkDetail.revenueTotal}}
                    </li>
                    <li class="flexList">
                        订单平均价格：{{charkDetail.averageMoney}}
                    </li>
                    <li class="flexList">
                        已完成单数：{{charkDetail.completeTotal}}
                    </li>
                    <li class="flexList">
                        未完成单数：{{charkDetail.notCompleteTotal}}
                    </li>
                    <li class="flexList">
                        退款单数：{{charkDetail.refundTotal}}
                    </li>
                </ul>
            </div>
...
export default {
    ...
    methods: {
        ...
        getEvaluateList() { // 获取医生排行列表
            ...
            this.instance.adminConsultationReportA({
                startTime,
                endTime,
                totalType,
            })
