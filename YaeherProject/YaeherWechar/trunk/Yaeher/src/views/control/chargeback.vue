<template>
    <div class="control-chargeback padding-top">
        <mt-header fixed title="退单率">
        ...
        <div class="content">
            ...
            <div>
                ...
                <ul>
                    <li class="flexList">
                        退单率：{{charkDetail.refundRate}}%
                    </li>
                    <li class="flexList">
                        退单总数：{{charkDetail.refundCount}}
                    </li>
                    <li class="flexList">
                        订单总数：{{charkDetail.consultationCount}}
                    </li>
                </ul>
            </div>
...
export default {
    ...
    methods: {
        ...
        getEvaluateList() { // 获取医生排行列表
            ...
            this.instance.qalityReturnReportC({
                startTime,
                endTime,
                totalType,
            })
