<template>
    <div class="index-evaluate padding-top">
        <mt-header fixed title="评价统计">
        </mt-header>
        <div ref="srcollBox" class="p-content index-control listAbout">
            ...
            <div>
                <ul v-infinite-scroll="getEvaluateList"
  				...
  				infinite-scroll-distance="10">
                    <router-link v-for="(item, index) in evaluateList" :key="index" tag="li" :to="{path: '/evaluate-detail', query: {typeEvaluate: 2, id: item.id}}" class="evaluateList">
