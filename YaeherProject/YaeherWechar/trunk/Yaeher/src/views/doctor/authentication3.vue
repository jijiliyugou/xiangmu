<template>
    <div class="authentication3 padding-top">
        <mt-header fixed title="怡禾认证3/3">
...
export default {
    ...
    methods: {
        ...
        putImgUpload () { // 上传图片参数
            ...
            if ('certificateofpractice' === typeDetail) {
                id = this.src2Id
            } else if ('qualificationcertificate' === typeDetail) {
                id = this.src1Id
            }
            ...
            this.instance.doctorFileApplyListD({
                ...
                .then((response) => {
                    ...
                    for (let i = 0; i < uploadParams.length; i++) {
                        if (uploadParams[i].typeDetail === 'certificateofpractice') {
                            _this.src2 = uploadParams[i].address
                            _this.src2Id = uploadParams[i].id
                        } else if (uploadParams[i].typeDetail === 'qualificationcertificate') {
