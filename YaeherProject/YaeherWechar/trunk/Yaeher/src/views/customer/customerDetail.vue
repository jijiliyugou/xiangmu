<template>
    <div class="customer-detail padding-top">
		<mt-header fixed title="咨询详情">
            <a v-if="returnShow" @click="$router.go(-1)" slot="left">
                <mt-button icon="back">返回</mt-button>
            </a>
            <mt-button slot="right">
                <router-link :to="{path: '/information-list', query: {consultantID: recordDetail.consultantID}}" class="right-white">联系患者</router-link>
            </mt-button> 
        </mt-header>
        <div class="content">
			<div class="condition">
